...
We optimize the BID (Fig.~\ref{fig:score_eu_lb_tt_tn}) and conduct ablation studies with the crowded actors configuration to establish a high precision effect and ensure a effective evaluation (Table~\ref{table:infraction}), allowing the proposed agent to attain a \emph{DS} of 96\%. 
