...
These features include both the appearance characteristics $ E_\text{V} $ of objects and motion-related information $ E_\text{S} $.
...
%
% 损失函数
Based on the inferred output $A_\text{t}$ and the expert's actual output $\hat{A}_\text{t}$, the model loss function is described as:
